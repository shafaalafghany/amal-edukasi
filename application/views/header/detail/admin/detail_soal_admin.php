      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if (current_url() == base_url('admin_soal/pilih_kategori_soal') || current_url() == base_url('admin_soal/edit_soal/' . $paket['id_paket'] . '/' . $event['id_event'] . '/' . $topik['id_topik_tes'] . '/' . $soal['id_soal'])) { ?>
              <li class="nav-item has-treeview menu-open">
                <a href="#" class="nav-link active">
